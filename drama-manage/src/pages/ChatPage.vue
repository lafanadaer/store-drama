    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                ...
                _this.tableData = []
                _this.tempDate = []
                _this.$axios.get(`${_this.$store.state.HOST}/chat`).then((res) => {
            ...
            saveEdit () {
                ...
                this.$axios.post(`${this.$store.state.HOST}/chat/update`, params)
                    .then(response => {
                        if (response.data) {
                            this.getData()
                            this.$notify({
            ...
            deleteRow () {
                var _this = this
                _this.$axios.get(`${_this.$store.state.HOST}/chat/delete?id=${_this.idx}`)
                    .then(response => {
                        if (response.data) {
                            _this.getData()
                            _this.$notify({
